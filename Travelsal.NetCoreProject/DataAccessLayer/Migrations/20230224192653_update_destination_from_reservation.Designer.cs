...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230224192653_update_destination_from_reservation")]
    partial class updatedestinationfromreservation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityLayer.Entity.Reservation", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Entity.Destination", "Destinations")
                        .WithMany("Reservations")
                        .HasForeignKey("DestinationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
